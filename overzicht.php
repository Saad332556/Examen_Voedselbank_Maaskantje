...
<body>
  <span style="color: green;">
    <h3><u>Overzicht Voedselpakketten</u></h3>
  </span>
  <table class="table table-bordered table-white">
    <thead>
      <tr>
        <th> Naam: <?= isset($data["naam"]) ? $data["naam"] : ''; ?></th>
        <th>Omschrijving: <?= isset($data["omschrijving"]) ? $data["omschrijving"] : ''; ?></th>
        <th>Totaal aantal Personen: <?= isset($data["aantalvolwassenen"]) ? $data["aantalvolwassenen"] : ''; ?></th>
      </tr>
    </thead>
  </table>
