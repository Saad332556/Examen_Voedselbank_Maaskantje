...
class Klant_d3_saad
{
    ...
    {
        // var_dump($data);exit();
        $this->db->query("UPDATE ContactPerGezin1
                          SET     Persoon1.Voornaam = :voornaam
                                  ...
                                  Persoon1.TypePersoon = :typepersoon
                                  Persoon1.IsVertegenwoordiger = :isvertegenwoordiger
        ...
        $this->db->bind(':typepersoon', $data['typepersoon'], PDO::PARAM_STR);
        $this->db->bind(':isvertegenwoordiger', $data['isvertegenwoordiger'], PDO::PARAM_BOOL);
