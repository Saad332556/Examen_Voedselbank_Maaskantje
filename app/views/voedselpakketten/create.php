...
<form action="<?= URLROOT; ?>/voedselpakketten/create" method="post">
    <table>
        <tbody>
            ...
            <tr>
                <td>Pakketnummer:</td>
                <td><input type="text" name="pakketnummer" id="pakketnummer"></td>
            </tr>
            <tr>
                <td>Samenstellingsdatum:</td>
                <td><input type="date" name="datum_samenstelling" id="datum_samenstelling"></td>
            </tr>
            <tr>
                <td>Uitgiftedatum:</td>
                <td><input type="date" name="datum_uitgifte" id="datum_uitgifte"></td>
            </tr>
            <tr>
