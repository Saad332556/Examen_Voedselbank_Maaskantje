   ...
   public function updateLeverancierUseSPMySql(LeverancierEntityViewModel $selectedLeverancier): bool
{
    try {
        ...
        $spQuery = "CALL spUpdateLeverancier(:id, :voornaam, :achternaam, :bedrijfsnaam, :adres, :contactpersoon, :emailadres, :telefoonnummer)";
        ...
        if ($this->Db->execute()) {
            ...
            error_log("ERROR : Selected Leverancier has not been modified in class LeverancierModel method updateLeverancierUseSP!", 0);
            return false;
        }
    } catch (PDOException $ex) {
